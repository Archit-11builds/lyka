...
export function Shell({ children }) {
  ...
  return (
    <div className="app-shell">
      ...
      <main>{children}</main>{!six && path === '/' && (
        <div className="home-six-launcher">
          <button className="home-six-trigger" onClick={openSix} type="button" aria-label="Open SIX Mode">
            <span>⚡</span>
            <div><b>SIX MODE</b><small>OPEN AT YOUR OWN RISK</small></div>
            <em>↗</em>
          </button>
        </div>
      )}
