...
export default function Home(){
 ...
 return <div className="lux-home">
  <section className="lux-hero">
   ...
   <div className="hero-art"><div className="art-card"><img src="/photos/anik-01.jpeg" alt="Anik"/><div className="art-shade"></div><div className="art-meta"><span>PORTRAIT / 001</span><b>ANIK</b></div></div><div className="art-float">LIVE<br/><strong>84</strong><small>ENERGY</small></div><div className="art-caption">NO SERIOUS BUSINESS<br/>BEYOND THIS POINT</div></div>
  ...
  <section className="intro-block"><div className="lux-label">01 / ABOUT THE THING</div><div><h2>It looks serious.<br/><em>It absolutely isn't.</em></h2><p>LYKA is a private little universe: part archive, part game room, part study lab. The surface is polished. The contents are not always.</p></div></section>

  <section className="feature-section"><div className="lux-label">02 / EXPLORE LYKA <span>04 MODULES</span></div><div className="feature-grid">{cards.map(x=><TransitionLink key={x.h} href={x.h} className={'feature-card '+x.c}><div className="feature-num">{x.n}</div><div className="feature-body"><small>{x.k}</small><h3>{x.t}</h3><p>{x.d}</p></div><div className="feature-arrow">↗</div></TransitionLink>)}</div></section>
  ...
  <section className="closing"><div className="lux-label">04 / END OF TRANSMISSION</div><h2>COME FOR THE<br/><em>DESIGN.</em><br/>STAY FOR THE CHAOS.</h2><TransitionLink href="/hq" className="lux-btn fill">OPEN HQ <b>↗</b></TransitionLink></section>
 </div>
}