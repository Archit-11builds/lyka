...
const cards=[
 ...
 {n:'04',k:'ARCHIVE / 04',t:'THE VAULT',d:'Photos, memes and classified material.',h:'/archive',c:'mint'}, {n:'05',k:'CHAOS / 05',t:'CHAOS GENERATOR',d:'Generate completely unnecessary events.',h:'/chaos',c:'violet'}, {n:'06',k:'TEST / 06',t:'ANIK IQ',d:'Three questions. Zero scientific validity.',h:'/iq',c:'coral'}, {n:'07',k:'LIVE / 07',t:'LIVE FEED',d:'Fake telemetry from the field office.',h:'/live',c:'sky'}, {n:'08',k:'FILES / 08',t:'INCIDENT ROOM',d:'Classified records with no useful purpose.',h:'/incidents',c:'mint'}
];
...
export default function Home(){
 ...
 return <div className="lux-home premium-home"><div className="ambient ambient-a"/><div className="ambient ambient-b"/><div className="grid-glow"/><div className="grain"/>
  ...
  <section className="feature-section reveal-block"><div className="lux-label"><span>02 / EXPLORE LYKA</span><span>08 MODULES / 04 NEW ROOMS</span></div><div className="new-room-banner"><b>NEW ROOMS / LIVE</b><span>CHAOS · IQ · LIVE FEED · INCIDENTS</span><i>SCROLL TO EXPLORE ↓</i></div><div className="feature-grid">{cards.map(x=><TransitionLink key={x.h} href={x.h} className={'feature-card '+x.c}><div className="feature-num">{x.n}</div><div className="card-graphic"><i/><i/><i/></div><div className="feature-body"><small>{x.k}</small><h3>{x.t}</h3><p>{x.d}</p></div><div className="feature-arrow">↗</div></TransitionLink>)}</div></section>
